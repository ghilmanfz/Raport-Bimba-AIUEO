...
<div class="max-w-5xl space-y-8">
    ...
    <div class="p-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div class="space-y-6">
        <div>
          ...
          <input type="text" value="BiMBA AIUEO Smart Education Centre" class="w-full px-4 py-2.5 border border-[#dee1e6] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#3d8af5]/20">
        </div>
        <div>
          <label class="block text-sm font-bold text-[#171a1f] mb-2">Alamat Lengkap</label>
          <textarea rows="4" class="w-full px-4 py-2.5 border border-[#dee1e6] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#3d8af5]/20 resize-none">Jl. Pendidikan No. 45, Jakarta Selatan, DKI Jakarta 12345</textarea>
        </div>
      </div>
      <div>
        <label class="block text-sm font-bold text-[#171a1f] mb-2">Logo Institusi</label>
        <div class="border-2 border-dashed border-[#3d8af5]/30 rounded-xl bg-[#3d8af5]/5 h-[220px] flex flex-col items-center justify-center p-6 text-center cursor-pointer hover:bg-[#3d8af5]/10 transition-colors">
  ...
  <section class="bg-white rounded-xl border border-[#dee1e6] overflow-hidden main-shadow">
    ...
    <div class="p-8 space-y-4">
      <!-- Administrator Role -->
      <div class="border border-[#dee1e6] rounded-2xl overflow-hidden">
        <div class="p-4 flex items-center justify-between bg-white">
          ...
          <iconify-icon icon="lucide:chevron-up" width="16" class="text-[#565d6d]"></iconify-icon>
        </div>
        <div class="px-6 pb-6 space-y-4 border-t border-[#dee1e6]">
      ...
      <!-- Motivator/Guru Role -->
      <div class="border border-[#dee1e6] rounded-2xl p-4 flex items-center justify-between">
        <div class="flex items-center gap-4">
    ...
    <div class="p-8 space-y-6">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="lg:col-span-2">
          ...
          <input type="password" placeholder="••••••••" class="w-full px-4 py-2.5 border border-[#dee1e6] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#3d8af5]/20">
        </div>
        <div>
  ...
  <div class="flex items-center justify-end gap-4 pb-8">
    <button class="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-[#565d6d] hover:bg-gray-100 rounded-xl">
      <iconify-icon icon="lucide:rotate-ccw" width="16"></iconify-icon>
      Reset Defaults
    </button>
    <button class="flex items-center gap-2 px-8 py-2.5 text-sm font-bold text-white bg-[#3d8af5] hover:bg-blue-600 rounded-xl shadow-lg shadow-blue-200">
