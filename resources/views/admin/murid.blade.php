  ...
  <div class="bg-white rounded-2xl p-8 w-full max-w-lg mx-4 shadow-xl">
    ...
    <form method="POST" action="{{ route('admin.murid.store') }}" class="space-y-4">
      ...
      <div>
        ...
        <input type="text" name="name" required class="w-full px-4 py-2 border border-[#dee1e6] rounded-xl text-sm focus:ring-2 focus:ring-[#F97316]/20 focus:outline-none" placeholder="Nama Lengkap">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="date" name="join_date" required value="{{ date('Y-m-d') }}" class="w-full px-4 py-2 border border-[#dee1e6] rounded-xl text-sm focus:ring-2 focus:ring-[#F97316]/20 focus:outline-none">
        </div>
      </div>
      <div>
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          ...
          <input type="text" name="parent_name" class="w-full px-4 py-2 border border-[#dee1e6] rounded-xl text-sm focus:ring-2 focus:ring-[#F97316]/20 focus:outline-none" placeholder="Nama Wali">
        </div>
        <div>
          <label class="block text-sm font-medium text-[#565d6d] mb-1">Email Wali</label>
          <input type="email" name="parent_email" class="w-full px-4 py-2 border border-[#dee1e6] rounded-xl text-sm focus:ring-2 focus:ring-[#F97316]/20 focus:outline-none" placeholder="email@wali.com">
        </div>
      </div>
