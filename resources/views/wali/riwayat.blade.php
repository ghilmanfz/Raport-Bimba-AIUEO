  ...
  <div class="flex items-center gap-4">
    ...
    <div>
      ...
      <div class="flex flex-wrap gap-3 mt-2">
        ...
        <div class="flex items-center gap-2 text-xs text-[#565d6d]">
          <iconify-icon icon="lucide:file-text" width="14" class="text-[#F97316]"></iconify-icon>
...
<div class="space-y-4">
  ...
  <div class="bg-white rounded-2xl border border-[#dee1e6] shadow-sm overflow-hidden {{ $period['is_current'] ? 'ring-2 ring-[#F97316]/20' : '' }}">
    <!-- Period Header -->
