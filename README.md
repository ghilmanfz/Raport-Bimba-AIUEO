...
- Absensi wali menampilkan identitas ringkas (nama, NIS, dan bulan), rekap H/S/I/A, serta riwayat tanpa persentase hadir. Identitas tetap tampil saat dicetak.
- Absensi dan grafik guru memakai pencarian nama/NIS tanpa filter kelas; parameter kelas dari tautan lama diabaikan. Pembatasan siswa bimbingan tetap berlaku, sedangkan filter kelas Admin tidak berubah.
- Istilah operasional pada role guru memakai "Siswa". Identitas rapor guru, wali, dan PDF menampilkan Level tanpa baris Kelas yang berulang; data kelas di database tetap digunakan.
